...
public class JPMenu extends javax.swing.JPanel {
    ...
    public JPMenu(JFWindow window) throws IOException, JDOMException, CloneNotSupportedException {
        ...
        name = JFWindow.socialWebCore.getLoggedUser().getUsername();
        names = new ArrayList<>();

        User user = userBusiness.loadUser(name);
        myCicularDoublyLinkedList.addEnd(userBusiness.loadUser(name));
        names.add(name);
        for (int i = 0; i < user.getFriends().getSize(); i++) {
            names.add(userBusiness.loadUser((String) user.getFriends().getByPosition(i)).getUsername());
            myCicularDoublyLinkedList.addEnd(userBusiness.loadUser((String) user.getFriends().getByPosition(i)).getPosts());
        }
    ...
    private void initComponents() {
        ...
        jtfNumPost = new javax.swing.JTextField();
            ...
            .addGroup(jPanelHomeLayout.createSequentialGroup()
                ...
                .addGroup(jPanelHomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelHomeLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtfPost, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanelHomeLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanelHomeLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelHomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jtfDate, javax.swing.GroupLayout.DEFAULT_SIZE, 86, Short.MAX_VALUE)
                            .addComponent(jtfNumPost))))
            ...
            .addGroup(jPanelHomeLayout.createSequentialGroup()
                .addGroup(jPanelHomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelHomeLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelHomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabelPostNumber)
                            .addComponent(jtfNumPost, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(16, 16, 16)
...
//        }//if
    ...
    private void jButtonNextPostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextPostActionPerformed
        ...
        //        }
        if(this.indexPost+1>this.myCicularDoublyLinkedList.getSize()){
            this.indexPost = 0;
            Post p = new Post();
            p = (Post) myCicularDoublyLinkedList.getByPosition(this.indexPost);
...
//        change(this.indexThought);
    ...
    private void jButtonPreviousThoughtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPreviousThoughtActionPerformed
        ...
        if(this.indexThought-1<0){
            this.indexThought = p.getThoughts().getSize();
            this.jTextArea1.append((String) p.getThoughts().getByPosition(this.indexThought));
        }else{
            this.indexThought++;
            this.jTextArea1.append((String) p.getThoughts().getByPosition(this.indexThought));
        }
    ...
    private void jButtonNextThoughtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextThoughtActionPerformed
        ...
        if (this.indexThought + 1 > p.getThoughts().getSize()) {
            this.indexThought = 0;
            this.jTextArea1.append((String) p.getThoughts().getByPosition(this.indexThought));
        } else {
            this.indexThought++;
    ...
    private javax.swing.JTextField jtfNumPost;
